...
bool HelloWorld::init() {
    ...
    touchListener2->onKeyReleased = CC_CALLBACK_2(HelloWorld::keyReleased, this);
...
void HelloWorld::checkGameOver(int x, int y, int player) {
    bool gameOver = true;
    float delay = 2.0f;
...
void HelloWorld::reset(int player, bool check) {
    ...
    this->scheduleOnce(schedule_selector(HelloWorld::removeAll), 2.7);
}

void HelloWorld::removeAll(float dt) {
